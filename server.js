...
// ---------------------------------------------------------------------------
// Data directory — shared by the SQLite progress DB, price alerts, and the
// auto-generated session/VAPID secrets.
// ---------------------------------------------------------------------------
...
// The alert store saves on a 250ms debounce — flush it on shutdown so an
// alert set moments before a restart survives. (SQLite writes are immediate.)
